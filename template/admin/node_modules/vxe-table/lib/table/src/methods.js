    ...
    containerList.forEach(function (name, index) {
      ...
      layoutList.forEach(function (layout) {
        ...
        if (layout === 'header') {
          ...
          var _renderColumnList = tableColumn; // 如果是使用优化模式
          ...
          var _renderColumnList2 = tableColumn; // 如果是使用优化模式
        ...
        if (operCtxMenu) {
          ...
          if (hasCtrlKey) {
            ...
            if (actived.row) {
              ...
              _this29.clearEdit(evnt); // 如果配置了选中功能，则为选中状态
  ...
  computeScrollLoad: function computeScrollLoad() {
    ...
    return this.$nextTick().then(function () {
      var sYOpts = _this52.sYOpts,
          ...
          scrollYStore = _this52.scrollYStore; // 计算 X 逻辑
