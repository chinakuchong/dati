...
.vxe-table--render-default.vxe-editable.size--medium .vxe-body--column, .vxe-table--render-default.size--medium .vxe-header--column.col--ellipsis,
...
.vxe-table--render-default.vxe-editable.size--small .vxe-body--column, .vxe-table--render-default.size--small .vxe-header--column.col--ellipsis,
...
.vxe-table--render-default.vxe-editable.size--mini .vxe-body--column, .vxe-table--render-default.size--mini .vxe-header--column.col--ellipsis,
...
.vxe-cell .vxe-default-input::-webkit-input-placeholder, .vxe-table--filter-wrapper .vxe-default-input::-webkit-input-placeholder {
  color: #C0C4CC; }
...
.vxe-table--cell-copy-area {
  ...
  -webkit-animation: moveCopyCellBorder .5s infinite linear;
...
/*圆角*/
.vxe-table--render-default.is--round .vxe-table--render-default.is--round, .vxe-table--render-default.is--round .vxe-table--border-line, .vxe-table--render-default.is--round:not(.is--header):not(.is--footer) .vxe-table--body-wrapper.body--wrapper {
  border-radius: 4px; }

.vxe-table--render-default.is--round.is--header .vxe-table--header-wrapper.body--wrapper, .vxe-table--render-default.is--round.is--footer:not(.is--header) .vxe-table--body-wrapper.body--wrapper {
...
.vxe-table--render-default.is--round.is--header:not(.is--footer) .vxe-table--body-wrapper.body--wrapper, .vxe-table--render-default.is--round.is--footer .vxe-table--footer-wrapper.body--wrapper {
  border-radius: 0 0 4px 4px; }

.vxe-table--render-default.is--round.is--header:not(.is--footer) .vxe-table--body-wrapper.fixed-left--wrapper, .vxe-table--render-default.is--round.is--footer:not(.is--header) .vxe-table--body-wrapper.fixed-left--wrapper, .vxe-table--render-default.is--round.is--footer .vxe-table--footer-wrapper.fixed-left--wrapper {
  border-radius: 0 0 0 4px; }

.vxe-table--render-default.is--round.is--header:not(.is--footer) .vxe-table--body-wrapper.fixed-right--wrapper, .vxe-table--render-default.is--round.is--footer:not(.is--header) .vxe-table--body-wrapper.fixed-right--wrapper, .vxe-table--render-default.is--round.is--footer .vxe-table--footer-wrapper.fixed-right--wrapper {
...
.vxe-table--render-default {
  ...
  .vxe-table--render-default .vxe-body--column.col--selected {
    -webkit-box-shadow: inset 0px 0px 0px 2px #409eff;
  ...
  .vxe-table--render-default.vxe-editable.cell--highlight .vxe-body--column.col--actived {
    ...
    .vxe-table--render-default.vxe-editable.cell--highlight .vxe-body--column.col--actived.col--valid-error {
      -webkit-box-shadow: inset 0px 0px 0px 2px #f56c6c;
